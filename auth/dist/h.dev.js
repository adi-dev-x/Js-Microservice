...
createDatabaseQuery = 'DELETE FROM quotation_list;'; //createDatabaseQuery='DELETE FROM customer;'
...
function () {
  ...
  _createClass(terminator, [{
    ...
    value: function terminate() {
      connection.connect(); // connection.query(terminateConnectionsQuery)

      connection.query(createDatabaseQuery); // .then(() => {
